...
(g=(門0%>%SET_門)[,c(1: 4, 6, 9,14,21,22,24,25)]%>%SNA)%>%plot(vertex.size=degree(g)*3,edge.width=E(g)$weight^.2*1.5,layout=layout.circle)
(g=(門0%>%SET_門)[,c(5, 7,10,15:20,23,26,28,29)]%>%SNA)%>%plot(vertex.size=degree(g)*3,edge.width=E(g)$weight^.2,layout=layout.circle)
(g=(門0%>%SET_門)[,c(8,11:13,27,30:32)]%>%SNA)%>%%>%plot(vertex.size=degree(g)*5,edge.width=E(g)$weight^.5*.1,layout=layout.circle)
(g=(門0%>%SET_門)[,33:37]%>%SNA)%>%plot(vertex.size=degree(g)*15,edge.width=E(g)$weight^.7*.1,layout=layout.circle)
(g=(門1%>%SET_門)[,c(
	1,2,9,13,14,19:23,28,30,
	3:6,12,15:18,24:27,
	8,10,11,31:37)]
	%>%SNA)%>%CFG(v=degree(g)^.8,e=E(g)$weight^.1)
(g=(門2%>%SET_門)[,c(
	1:3,10,14,16,22,23,
	4:6,9,13,17,19,21,24:27,32,
	8,11,12,15,18,20,28:31,33:37)]
	%>%SNA)%>%CFG(v=degree(g)^.4*4,e=E(g)$weight^.1)
(g=(門3%>%SET_門)[,c(
...
(g=(住0%>%SET_住)[,c(1,7: 9,11,14,16,17,21,23,25,27,29,31)]%>%SNA)%>%plot(vertex.size=degree(g)^.5*10,edge.width=E(g)$weight^.2*2,layout=layout.circle)
(g=(住0%>%SET_住)[,c(2:6,10,12,15,18:20,22,24,26,28,30,32)]%>%SNA)%>%plot(vertex.size=degree(g)^.5*10,edge.width=E(g)$weight^.4*2,layout=layout.circle)
(g=(住0%>%SET_住)[,c(13,33:37)]%>%SNA)%>%plot(vertex.size=degree(g)*10,edge.width=E(g)$weight^.5,layout=layout.circle)
(g=(住1%>%SET_住)[,c(35,8,9,11,14,16,17,21,6,20,22,23,25,26,29,5,33,34)]%>%SNA)%>%CFG(v=degree(g)^.4*15,e=E(g)$weight^.4)
(g=(住2%>%SET_住)[,c(4,6,14,24,33:37)]%>%SNA)%>%CFG(v=degree(g)*15,e=E(g)$weight^.5)
